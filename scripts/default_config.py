...
def get_default_config():
    ...
    cfg.data.workers = 0 # number of data loading workers
    ...
    cfg.loss.triplet.weight_x =1.0 # weight to balance cross entropy loss
    cfg.loss.triplet.weight_s =1.0 # weight to balance scp loss
    ...
    cfg.test.ranks = [1, 3, 5, 10] # cmc ranks
