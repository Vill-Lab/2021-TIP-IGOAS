...
def visactmap(
    ...
    for target in list(test_loader.keys()):
        data_loader = test_loader[target]['gallery']  # only process query images
...
def main():
    ...
    parser.add_argument('-d', '--dataset', type=str, default='occludedduke')
    parser.add_argument('-m', '--model', type=str, default='bfe')
    parser.add_argument('--weights', type=str, default='/home/ubuntu/reid/log/best_occlusionduke/model.pth.tar-60')
    parser.add_argument('--save-dir', type=str, default='log/visactmap_bre')
    ...
    test_loader = datamanager.testloader
